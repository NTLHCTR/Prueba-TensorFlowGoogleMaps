package com.example.pruebatensorflowgooglemaps;
...
import com.example.pruebatensorflowgooglemaps.ml.ModelBanderas;
        ...
        implements OnSuccessListener<Text>, OnFailureListener, ImageAnalysis.Analyzer, ImageReader.OnImageAvailableListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ImageFlag = findViewById(R.id.imgflag);
    }
    ...
    private void processImage() {
        ...
        try {
            ...
            for (i = 0; i < probability.size(); i++)
                res = res + "Estado: " + probability.get(i).getLabel()+ "\nConfianza: " + probability.get(i).getScore() * 100 + " % \n" ;
                cont+=1;

            RequestQueue queue = Volley.newRequestQueue(this);
            String url = "http://www.geognos.com/api/en/countries/info/"+probability.get(cont).getLabel()+".json";
            StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                ...
                public void onErrorResponse(VolleyError error) {
                    Descripcion="Error al procesar información";
                }
            });
            queue.add(stringRequest);
            txtResults.setText(res + "\n");
            txtDescripcion.setText("Información del País:\n" + Descripcion);
            model.close();
